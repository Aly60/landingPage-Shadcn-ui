  ...
  const sections = [
    {
      ...
      text: "ليس هنـــاك حاجـــة للتقيد داخـــل المكاتـــب المغلقـــة، يمكـــن اســـتخدام النظام مـــن أي مـــكان بالعالم",
    },
    {
    ...
    },
    {
      ...
      text: "أي ســـكوب يســـتخدم احـــدث التقنيـــات العالميـــة في نمذجـــة معلومـــات البنـــاء خـــال رســـومات ثلاثية الابعـــاد.",
    },
  ];
